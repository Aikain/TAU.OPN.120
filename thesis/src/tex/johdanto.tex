...
% suunnitelutieteen metodiikka tyylinen (iteroidaan, valitaan -> testataan -> arvioidaan -> (toistetaan?) -> valitaan "paras")
% hewnerin julkaisuja suunnittelutieteestä, (eng. design jotain), painotus tietojärjestelmätieteen puolelle, mutta voidaa soveltaa, varovasti mukaan ei välttämättä toimi suoraan
% 7 kohtaa, joita tarkistellaan (saadaan sillä arvioitua helpommin?)
