...
Avoimeen lähdekoodiin pohjautuvista ratkaisuista esille tulee Sunon luoma
...
visuaalisten toteutusten kanssa hyvin. Kuten suuret kielimallitkin, käyttää
Sora transformer-arkkitehtuuria. Kuitenkin erona se, että Sora on nimenomaan
diffuusio transformer -malli. \parencite{openAISoraReport} Transformer-malli on
Googlen kehittämä arkkitehtuuri \parencite{googleAttentionIsAllYouNeed} kun
diffuusio malli puolestaan koulutetaan poistamaan kohina datasta
\parencite{song2021scorebased}.
